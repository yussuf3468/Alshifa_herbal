...
export default function Checkout({ onClose }: { onClose: () => void }) {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    try {
      ...
      // Stock was decremented server-side — refresh the catalog so availability
      // is current, and refresh any admin order views.
      void invalidateProductCaches(queryClient);
