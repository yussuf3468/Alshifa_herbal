...
export default function SalesHistory() {
  ...
  // create HTML used for printing (clean, professional Al-Shifa Herbal receipt)
...
<head>
<meta charset="UTF-8" />
<title>Receipt ${escapeHtml(transaction.transaction_id.slice(0, 8))} — Al-Shifa Herbal</title>
...
<body>
  <div class="receipt">
    ...
    <div class="brand-bar">
      <div>
        <h1 class="brand-name">Al-Shifa <span class="accent">Herbal</span></h1>
        <div class="brand-tag">Natural Remedies · Wellness · Pure Honey</div>
      </div>
      <div class="brand-meta">
        <strong>2nd Street, 3rd Avenue, Eastleigh</strong><br />
        Nairobi, Kenya<br />
        +254 722 979 547 · info@alshifaherbal.co.ke
      </div>
    </div>
    ...
    <div class="footer">
      <div class="thanks">Thank you for shopping with Al-Shifa Herbal!</div>
                ...
                <div className="max-w-[820px] mx-auto bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                      ...
                      <div className="md:text-right text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                        <div className="font-semibold text-slate-800 dark:text-slate-200">
                          2nd Street, 3rd Avenue, Eastleigh
                        </div>
                        <div>Nairobi, Kenya</div>
                        <div>+254 722 979 547</div>
                        <div className="break-all">info@alshifaherbal.co.ke</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="px-5 md:px-8 py-5 border-t border-dashed border-slate-300 dark:border-slate-700 text-center">
                    <p className="text-sm font-bold text-amber-600 dark:text-amber-400">
                      Thank you for shopping with Al-Shifa Herbal!
                    </p>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
