...
export default function HorumarStorefront({ onAdminClick }: HorumarStorefrontProps) {
  ...
  const seoTitle =
    currentPage === "home"
      ? "Al-Shifa Herbal - Natural Remedies & Wellness"
      : currentPage === "catalog"
        ? searchTerm.trim()
          ? `Search results for ${searchTerm} - Al-Shifa Herbal`
          : "Shop All Products - Al-Shifa Herbal"
        : currentPage === "product" && selectedProduct
          ? `${selectedProduct.name} - Al-Shifa Herbal`
          : "My Dashboard - Al-Shifa Herbal";

  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <SEO
        title={seoTitle}
        description="Natural herbal remedies, wellness teas, raw honey and immunity boosters in Eastleigh, Nairobi. Quality products for families and communities. Shop online with fast delivery."
        keywords="Al-Shifa Herbal, herbal shop, Kenya, Nairobi, Eastleigh, natural remedies, wellness teas, raw honey, black seed oil, online shopping"
      />
