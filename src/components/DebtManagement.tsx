...
export default function DebtManagement() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      default:
        return "bg-gradient-to-br from-amber-50/30 to-white text-yellow-800";
    }
  };
          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 flex items-center gap-2"
              >
              ...
              <button
                ...
                className="bg-gradient-to-r from-red-600 to-rose-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl hover:from-red-700 hover:to-rose-700 transition-all duration-300 flex items-center gap-2"
              >
                            ...
                            <span
                              className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                                debt.status === "closed"
                                  ...
                                  : "bg-gradient-to-br from-white via-amber-50/20 to-white0/20 text-yellow-300 border border-yellow-500/30"
                              }`}
                            >
                              {debt.status === "closed"
                                ? "✓ Closed"
            ...
            <div className="bg-gradient-to-br from-white via-amber-50/20 to-white backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-8 w-full max-w-2xl shadow-2xl border border-amber-300/70 shadow-sm max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 pt-3 sm:pt-4">
                  ...
                  <button
                    type="submit"
                    className="flex-1 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-red-600 to-rose-600 text-white rounded-xl sm:rounded-2xl hover:from-red-700 hover:to-rose-700 transition-all duration-300 text-sm sm:text-base"
                  >
            ...
            <div className="bg-gradient-to-br from-white via-amber-50/20 to-white backdrop-blur-xl rounded-3xl p-8 w-full max-w-md shadow-2xl border border-amber-300/70 shadow-sm max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handlePaymentSubmit} className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 pt-3 sm:pt-4">
                  ...
                  <button
                    type="submit"
                    className="flex-1 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl sm:rounded-2xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 text-sm sm:text-base"
                  >
                    Record Payment
                  </button>
                </div>
