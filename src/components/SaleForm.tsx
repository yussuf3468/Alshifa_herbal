...
//   // Selected saved customer's phone ("" = Walk-in). When set, the sale is on
//   // credit and its total is added to that customer's balance in Customer Credit.
//   const [customerPhone, setCustomerPhone] = useState("");
//   // Distinct customers that already have credit records, for the selector.
...
//     try {
//       // A credit sale (saved customer selected) is recorded as unpaid; the
//       // total is added to their Customer Credit balance below.
//       const effectiveCustomerName = customerName || "Walk-in Customer";
//       const effectivePaymentStatus = isCreditSale ? "not_paid" : paymentStatus;
//       const effectiveAmountPaid = isCreditSale
//         ? 0
...
// <head>
// <meta charset="UTF-8" />
// <title>Receipt - Al-Shifa Herbal</title>
// <style>
...
// <body>
//   <div class="header">
//     <h1>Al-Shifa Herbal</h1>
//     <div class="sub">Natural Remedies · Wellness · Pure Honey</div>
//     <div class="sub">Tel: +254 722 979 547 · Email: info@alshifaherbal.co.ke</div>
...
//                   Natural Remedies · Wellness · Pure Honey
//                 </p>
//                 <p className="text-xs text-gray-600 dark:text-gray-400">
//                   Tel: +254 722 979 547 | Email: info@alshifaherbal.co.ke
//                 </p>
...
//                       {isCreditSale ? (
//                         /* Credit sale: the full total is added to the customer's
//                            balance — no on-the-spot payment fields. */
//                         <div className="rounded-lg border border-amber-200 dark:border-amber-700 bg-amber-50 dark:bg-amber-900/20 px-3 py-2.5 text-xs text-amber-800 dark:text-amber-300">
//                           This sale is <strong>on credit</strong>. The total will
//                           be added to <strong>{customerName}</strong>'s balance in
//                           Customer Credit.
//                         </div>
//                       ) : (
//                         <>
