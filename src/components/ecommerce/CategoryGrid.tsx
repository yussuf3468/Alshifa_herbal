import { Leaf, Droplets, FlaskConical, Sparkles, Grid } from "lucide-react";
...
const categories = [
  ...
  },
  {
    ...
    darkBgGradient: "dark:from-lime-950 dark:to-green-950",
  },
  {
    ...
    darkBgGradient: "dark:from-teal-950 dark:to-emerald-950",
  },
  {
    name: "All Products",
    icon: Grid,
