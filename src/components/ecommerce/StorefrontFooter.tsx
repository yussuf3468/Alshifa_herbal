        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-2xl font-black">AL-SHIFA HERBAL</h3>
                <p className="text-xs text-amber-200">Your Business. Your Progress.</p>
              </div>
            </div>
            <p className="text-sm text-amber-100">
              Natural herbal remedies, wellness teas, raw honey and immunity boosters in
              Eastleigh, Nairobi. Quality products for families and communities.
            </p>
            {/* Social Links */}
        ...
        <Container className="py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-quaternary">
            <p className="text-center sm:text-left">
              © {currentYear} Al-Shifa Herbal. All rights reserved.
            </p>
