...
export default function Reports() {
  ...
  function exportInventoryToPDF() {
    ...
    doc.text("Al-Shifa Herbal", 105, 15, { align: "center" });
    ...
    // Save the PDF
    const filename = `AlShifaHerbal_Inventory_Report_${
  ...
  function exportInventoryPrintPDF() {
    ...
    doc.setFontSize(18);
    doc.setFont("helvetica", "bold");
    doc.text("Al-Shifa Herbal", 105, 11, { align: "center" });
    ...
    const filename = `AlShifaHerbal_Inventory_Print_${
      new Date().toISOString().split("T")[0]
    }.pdf`;
    doc.save(filename);
  }
  ...
  function exportSalesPDF() {
    ...
    // Save the PDF
    const filename = `AlShifaHerbal_Sales_Report_${rangeLabel}_${
      new Date().toISOString().split("T")[0]
    }.pdf`;
    doc.save(filename);
  }
