...
const TICKERS = [
  "🌿 New Stock: Fresh Herbal Remedies Just Arrived!",
  "🌿 Buy Any 2 Herbal Teas, Get 10% Off — Today Only!",
  "🍯 Raw Honey Bundle Deals Starting from KES 150",
  "🚚 Free Delivery on Orders Over KES 2,000 Within Nairobi",
  "💧 Fresh Black Seed Oil Now In Stock",
  "⭐ Rated #1 Herbal Shop in Eastleigh — 5,000+ Happy Customers",
];
...
const CATEGORIES = [
  ...
  {
    icon: "🌱",
    label: "Spices & Superfoods",
    somali: "Xawaash & Cunto Caafimaad",
    count: "100+",
    badge: "",
              ...
              >
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/10 border border-amber-500/25 rounded-full">
                  ...
                  <span className="text-amber-300 text-sm font-semibold tracking-wide">
                    Al-Shifa Herbal — Eastleigh, Nairobi
                  </span>
                </div>
                ...
                <p className="text-slate-300 text-lg leading-relaxed max-w-xl">
                  From{" "}
                  <span className="text-amber-400 font-semibold">herbal remedies</span> to
                  pure raw honey — Nairobi's most trusted natural wellness shop,
                  serving families since 2010.
                  <span className="block mt-2 text-amber-400/70 text-base font-somali font-normal">
                    Wax walba oo caafimaadkaaga u baahan yahay
                  </span>
                </p>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <span className="text-slate-400 text-sm">· 5,000+ happy customers</span>
